...
public class TipoHabitacionRepository {
    ...
    public TipoHabitacionRepository() {
        tiposHabitacion.add(new TipoHabitacion(1L, "Normal", "Elegant essentials for a refined stay. 1-2 guests, double bed, private bathroom, premium Wi-Fi."));
        tiposHabitacion.add(new TipoHabitacion(2L, "Executive", "Designed for those who work while they travel. 1-2 guests, executive workspace, king bed, premium Wi-Fi."));
        tiposHabitacion.add(new TipoHabitacion(3L, "VIP", "A private space to relax and unwind. Up to 3 guests, separate living area, premium amenities, city views."));
        tiposHabitacion.add(new TipoHabitacion(4L, "Luxury", "The ultimate expression of The Royale. Up to 4 guests, full suite, jacuzzi, privileged city view."));
    }
